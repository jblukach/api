...
class ApiUse1(Stack):
    ...
    ### IPINFO FUNCTION ###
        ...
        ipinfo = _lambda.Function.from_function_attributes(
            self, 'ipinfo',
            function_arn = 'arn:aws:lambda:us-east-1:'+ipinfoaccount.string_value+':function:find',
            same_environment = False,
            skip_permissions = True
        )
    ...
    ### IPLOCATION FUNCTION ###
        ...
        iplocation = _lambda.Function.from_function_attributes(
            self, 'iplocation',
            function_arn = 'arn:aws:lambda:us-east-1:'+iplocationaccount.string_value+':function:lookup',
            same_environment = False,
            skip_permissions = True
        )
